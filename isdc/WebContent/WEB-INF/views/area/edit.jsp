...
<title>e-Distribution and Channel Management | Update Area</title>
...
<div class="container">
	<div class="panel panel-default">
	  <div class="panel-heading">
		...
		<spring:url value="/area/edit" var="formUrl" />
		<spring:url value="/area/edit.json" var="formJsonUrl" /> 
		<form:form modelAttribute="areamaster" id="edit-area-form" action="${formUrl}" method="POST" onsubmit="return submitFormFn();">    
		
			<form:hidden path="area_id" />
		
			<div class="form-group" id="area_name_field">
			    <label for="area_name">Name</label>
			    <form:input path="area_name" class="form-control" placeholder="Name" />
