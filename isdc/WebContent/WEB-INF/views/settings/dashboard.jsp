...
<title>e-Distribution and Channel Management | Settings Dashboard</title>
...
<div class="container">
	<div class="panel panel-default">
	  <div class="panel-heading">
	    <div class="floatleft"><h3 class="panel-title">Settings Dashboard</h3></div>
	    <spring:url value="/settings/add" var="addURL" />
	  ...
	  <div class="panel-body"> 
	  	...
	  	<core:if test="${param.message=='create-success'}">												
		  	<div class="alert alert-success">
		        <strong>Success!</strong> Create settings entry request was completed successfully.
		   	</div>					
		</core:if>
		<core:if test="${param.message=='update-success'}">												
		  	<div class="alert alert-success">
		        <strong>Success!</strong> Update settings entry request was completed successfully.
		   	</div>					
		</core:if>
		<core:if test="${param.message=='delete-success'}">												
		  	<div class="alert alert-success">
		        <strong>Success!</strong> Delete settings entry request was completed successfully.
		   	</div>					
		</core:if>
		<core:if test="${param.message=='delete-fail'}">												
		  	<div class="alert alert-danger">
		        <strong>Error!</strong> Delete settings entry request could not be completed, the settings is assigned to a product.
		   	</div>					
		</core:if>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
			...
			<tbody>
			<core:forEach items="${settingslist}" var="settingslist">
				<tr class="odd gradeU">
					<td><core:out value="${settingslist.settings_id}" /></td>
					<td><core:out value="${settingslist.settings_label}" /></td>
					<td><core:out value="${settingslist.settings_value}" /></td>
					<td><core:out value="${settingslist.settings_created_date}" /></td>
					<td><core:out value="${settingslist.settings_updated_date}" /></td>
					<spring:url value="/settings/edit?id=${settingslist.settings_id}" var="editURL" />
					<spring:url value="/settings/delete?id=${settingslist.settings_id}" var="deleteURL" />
					<td>
