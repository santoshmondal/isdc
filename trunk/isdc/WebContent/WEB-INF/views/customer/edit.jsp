...
<title>e-Distribution and Channel Management | Update Customer</title>
...
<div class="container">
	<div class="panel panel-default">
	  <div class="panel-heading">
		...
		<spring:url value="/customer/edit" var="formUrl" />
		<spring:url value="/customer/edit.json" var="formJsonUrl" /> 
		<spring:url value="/customer/select.json" var="selectJsonUrl" /> 
		<form:form modelAttribute="customermaster" id="edit-customer-form" action="${formUrl}" method="POST" >    
		...
		<form:hidden path="customer_id" />  
			...
			<div class="form-group" id="areamasterstring_field">
			    ...
			    <form:select multiple="single" path="areamasterstring" class="form-control" >
			    	<core:forEach items="${areamasterarray}" var="customerarea" varStatus="loop">
			    		<core:set var="areamasterselected" value=" "></core:set>			    		
			    		<core:set var="areamasterselected" value="${customermaster.areamaster.area_id == customerarea.area_id ? 'selected' : ' '}"></core:set>
			    		<form:option value="${customerarea.area_id}" label="${customerarea.area_name}" selected="${areamasterselected}"/>		    		
			    	</core:forEach>
				</form:select>
			...
			<div class="form-group" id="beatmasterstring_field">
			    ...
			    <form:select multiple="single" path="beatmasterstring" class="form-control" >
			    	<core:forEach items="${beatmasterarray}" var="customerbeat" varStatus="loop">
			    		<core:set var="beatmasterselected" value=" "></core:set>			    		
			    		<core:set var="beatmasterselected" value="${customermaster.beatmaster.beat_id == customerbeat.beat_id ? 'selected' : ' '}"></core:set>
			    		<form:option value="${customerbeat.beat_id}" label="${customerbeat.beat_name}" selected="${beatmasterselected}"/>		    		
			    	</core:forEach>
				</form:select>
