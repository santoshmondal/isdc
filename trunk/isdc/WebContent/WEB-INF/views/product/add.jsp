...
<title>e-Distribution and Channel Management | Create Product</title>
...
<div class="container">
	<div class="panel panel-default">
	  <div class="panel-heading">
		...
		<spring:url value="/product/add" var="formUrl" />
		<spring:url value="/product/add.json" var="formJsonUrl" /> 
		<form:form modelAttribute="productmaster" id="add-product-form" action="${formUrl}" method="POST" onsubmit="return submitFormfn();">   
			...
			<div class="form-group" id="product_master_expiry_date_field">
				...
				<form:input id="expiry_date" value="${formattedDate}" path="product_master_expiry_date" class="form-control" placeholder="Expiry Date (DD/MM/YYYY)"  />
			...
			<div class="form-group" id="product_master_vat_type_field">
			    <label for="product_master_vat_type">Tax Calculation</label>
			...
			<div class="form-group" id="taxmasterlist_field">
			    <label for="taxmasterlist">Tax</label>
			    <form:select multiple="true" class="form-control" path="taxmasterlist" items="${taxmasterarray}" itemValue="tax_id" itemLabel="tax_name"/>
...
<script type="text/javascript" src="${resourcesURL}/jquery/jquery-ui.min.js"></script>
