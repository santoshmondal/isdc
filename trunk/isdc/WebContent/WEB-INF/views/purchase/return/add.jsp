...
<div class="container">
	<div class="panel panel-default">
	  <div class="panel-heading">
	    <div class="pull-left"><h3 class="panel-title">New Sales Return</h3></div>
	    <div class="pull-right"><strong></strong>&nbsp;<span id="invoiceno">${invoiceno}</span></div>
	  ...
	  <div class="panel-body">
	    <div class="content">
	 		...
	 		<table border="1" id="mainTable">
				...
				<tbody>
					<tr id="LastRow">
						...
						<td><div><input type="text" class="productQuantity text_field"><span class="oldQuantity"></span></div></td>
						<td><div><input type="text" class="defected text_field"></div></td>
						<td><div class="productRate tBox"></div></td>
			...
			<div class="save_button">
				<button id="ReturnSaveBtn" type="submit" class="btn btn-primary">Save</button>
			</div>
        </div>
...
<script src="${resourcesURL}/js/purchaseReturn.js?ts=<%=ts%>"></script>
