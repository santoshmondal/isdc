...
<div class="container">
	<div class="panel panel-default">
	  <div class="panel-heading">
	    <div class="floatleft"><h3 class="panel-title">Sales Return Dashboard</h3></div>
	    <spring:url value="/sales/return/add" var="addURL" />
	  ...
	  <div class="panel-body"> 
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="dashboard" width="100%">
			...
			<tbody>
			<core:forEach items="${salesReturnList}" var="salesReturn" varStatus="counter">
				<tr>
					<td>${counter.count}</td>
					<td><core:out value="${salesReturn.salesMaster.sales_master_invoice}" /></td>
					<td><core:out value="${salesReturn.salesMaster.sales_product_customer.customer_name}" /></td>
					<td><core:out value="${salesReturn.salesReturnAmount}" /></td>
					<td><core:out value="${salesReturn.salesReturnQuantity}" /></td>
					<td><fmt:formatDate value="${salesReturn.updatedDate}" pattern="dd-MM-yyyy" /></td>				
					<spring:url value="/product/edit-${salesReturn.id}" var="editURL" />
					<spring:url value="/product/delete-${salesReturn.id}" var="deleteURL" />
					<td>
