...
<title>e-Distribution and Channel Management | Create Settings</title>
...
<div class="container">
	<div class="panel panel-default">
	  <div class="panel-heading">
	    <h3 class="panel-title">Create New Setting</h3>
	  </div>
	  	<div class="panel-body"> 

		<spring:url value="/settings/add" var="formUrl" />
		<spring:url value="/settings/add.json" var="formJsonUrl" /> 
		<form:form modelAttribute="settings" id="add-settings-form" action="${formUrl}" method="POST" onsubmit="return submitFormFn();">    
		
			<div class="form-group" id="settings_label_field">
			    <label for="settings_label">Label</label>
			    <form:input path="settings_label" class="form-control" placeholder="Label" />
