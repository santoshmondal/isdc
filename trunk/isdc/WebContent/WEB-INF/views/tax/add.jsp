...
<title>e-Distribution and Channel Management | Create Tax</title>
...
<div class="container">
	<div class="panel panel-default">
	  <div class="panel-heading">
	    <h3 class="panel-title">Create New Tax</h3>
	  </div>
	  	<div class="panel-body"> 

		<spring:url value="/tax/add" var="formUrl" />
		<spring:url value="/tax/add.json" var="formJsonUrl" /> 
		<form:form modelAttribute="taxmaster" id="add-group-form" action="${formUrl}" method="POST" onsubmit="return submitFormFn();">    
